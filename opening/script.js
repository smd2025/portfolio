...
window.addEventListener("resize", () => {
  // Handle all canvas elements
  const canvases = ["particles-background", "fireworks", "confetti"]
  ...
  window.resizeTimer = setTimeout(() => {
    ...
    if (particlesCanvas && !finalCountdownActive) {
      // Optional: Reinitialize particle positions on major resize
